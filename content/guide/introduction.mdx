...
JellyCAD is a digital resource for learning how to use CAD for the FIRST Tech Challenge! In this guide, we’ll teach you how to harness the capabilities of Fusion360 for your FTC robot, starting with simple modeling all the way to complex part modeling and large assemblies. Get started 
